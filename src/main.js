...
import {
    ensureCtx, resumeCtx, ensureWorklet, updateLatencyOffset,
} from './audio-ctx.js';
import { makeStemGainHandle } from './mix.js';
import {
    setupStreaming, repositionStream, resetStreamState, streamingSupported,
    streamOffsetBuffered, isWavResponse, configureStreaming,
} from './streaming.js';
import {
...
(function () {
    ...
    // Wire the streaming layer's seams back to this orchestration layer (it can't
    // import main.js). These are hoisted function declarations, so callable now.
    configureStreaming({
